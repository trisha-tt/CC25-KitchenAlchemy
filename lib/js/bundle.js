...
// 	winModal.alpha = 1;
// 	winModal.graphics.drawRect(140, 100, 500, 300);
...
// 	// line between the two compartments	
...
// 		var modalLabel = new createjs.Text("kitchen Alchemy", "40px Fantasy", "#000");
// 		modalLabel.x = 490;
// 		modalLabel.y = 120;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var update = true;
	var initial = ["flour","water","sugar"];
	var all = ["flour", "water", "sugar", "butter", "cake", "cheese", "dough", "egg", "grilledCheese", "iceCream", "lemonade", "milk", "pancake", "paneer", "tomato", "waffle", "water"];
	...
	line.graphics.endStroke();
	  ...
	  initial.forEach(el => {
	    ...
	    image.onload = handleImageLoad.bind(elObj);
	  	...
	  	// // function for shop purchasing (marked)
		// var image =  document.getElementById("shop-item");

		// function isPurchased(image) {
		// var parentBox = image.closest('.box');
		// var label = parentBox.querySelector('.shop-label');

		// 	if (image.getAttribute('src') != "/assets/img/purchased.png") {
		// 		image.src = "/assets/img/purchased.png";
		// 		label.textContent = "Purchased!";
		// 	}
		// }

		// // If targeting only one specific item
		// if (image) {
...
/***/ function(module, exports) {
	...
	var recipes = [["dough",["flour", "water"]],["cake", ["dough", "egg"]],["lemonade", ["lemon", "sweet water"]],["pancake", ["dough", "milk"]],["cheese", ["lemon", "milk"]], ["paneer", ["cheese", "cheese"]],["grilled cheese", ["dough", "cheese"]] ];
